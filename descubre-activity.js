...
var $eXeDescubre = {
    ...
    loadDataGameOld: function (data, imgsLink0, audioLink0, imgsLink1, audioLink1, imgsLink2, audioLink2, ) {
        var json = data.text();
    ...
    showCard: function (card, instance) {
        ...
        if (typeof (MathJax) != "undefined") {
            MathJax.Hub.Queue(["Typeset", MathJax.Hub, '#descubreGameContainer-' + instance]);
        }
    },
    ...
    enterCodeAccess: function (instance) {
        var mOptions = $eXeDescubre.options[instance];
        if (mOptions.itinerary.codeAccess == $('#descubreCodeAccessE-' + instance).val()) {
            $('#descubreCodeAccessDiv-' + instance).hide();
            $('#descubreCubierta-' + instance).hide();
            $('#descubreStartLevels-' + instance).show();
