...
var $eXeFlipCards = {
    ...
    showCard: function (card, instance) {
        ...
        $eXeFlipCards.updateLatex(instance);
    },
    ...
    updateLatex: function (instance) {
        if (typeof (MathJax) != "undefined") {
            try {
                var nodo = document.getElementById('flcdsGameContainer-' + instance);
                MathJax.typesetClear([nodo]);
                MathJax.typeset([nodo]);
            } catch (error) {                
                try {
                    MathJax.Hub.Queue(["Typeset", MathJax.Hub, '#flcdsGameContainer-' + instance]);
                } catch (error) {
                    console.log('Error refrecar mathjax')
                }
            }
